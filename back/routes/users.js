...
const { findAllUsers, createUser, updateUser, checkEmptyNameAndEmail, deleteUser, hashPassword, checkEmptyNameAndEmailAndPassword, checkIsUserExists } = require('../middlewares/users')
...
userRouter.post('/users', findAllUsers, hashPassword, checkAuth, checkEmptyNameAndEmailAndPassword, checkIsUserExists, createUser, sendUserCreated);
